...
혹시나 했지만 역시나 시작부터 -소리다.
책을 읽어서 성공할 수 있다면 누가 읽지 않겠는가.
그러나 실제로 성공하기위해 집요하게 책을 파고드는 사람은 적다.
단순히 지식을 습득하기 위해서가 아니라 바로 실전에 적용하기 위해서 읽는 독서는 다르다.

![책읽기의 중요성](blob:file:///cdfb3ee0-f9e2-4258-ae91-54cd59569736)

자청은 지인들과의 포커판에서 한 번을 이기지 못하고 계속 지게 된다.
...
마치 포커를 10년을 친 자청의 지인도 책을 읽지 않았던 것처럼.그러나책 읽기만으로는 성공에 부족하다.
...
결론적으로 잘 놀려면 높은 데서 놀아라는 말인데, 쥐뿔도 없는데 어떻게 가능한가.
자청은 여기서 마케팅으로 뚫어냈다.
자청은 그의 회사 '이상한 마케팅'을 설립하는 데 그의 놀라운 마케팅 능력을 이용했다.
그는 먼저 글쓰기와 블로그 마케팅 능력을 키웠다.
글쓰기는 대학교 시절 능력을 키웠고 블로그는 마케팅에 대한 감각이 있었기에 며칠만에 금방 익혔다.
이후 그는 무작정 로펌을 찾아갔다.
...
당시 자기계발 분야에서 대형 유튜버이던 신사임당과 느으 를 끌어들인다.
신사임당이 하위권인 이유라는 자극적인 제목으로 영상을 보게한다.
영상에서는 신사임당을 분석하고 그를 지지한다.
이렇게해서 신사임당 채널을 보는 구독자, 비즈니스와 창업에 관심있는 시청자들을 유입할 수 있다.

그는 자신도 신사임당처럼 대단한 인물이라고 묶는다.
평범한 사람부터 나도 신사임당처럼 성공했다.
한강 뷰와 연봉 10억이라는 타이틀은 충분히 그에게 환상을 갖게 한다.
티어올리기가 성공한 것이다.
...
### 05. 자청의 한계
자청의 말은 어수선하다.
이야기를 듣고 있으면 사람이 굉장히 해박하고 경험이 많다는 것을 알 수 있다.
...
물론 나이키, 삼성, 인텔, 네슬레 등 대기업들도 CSV를 "모토"로서 내걸고 있다.
<br>
...
이 문장이 무슨 의미를 가지는지 방금 읽고도 당신은 이해할 수 없다.마찬가지로 '마케팅의 최적화의 발생'이 무엇을 뜻하는지 아무도 모른다.
그러나 화자가 단호한 태도를 취하거나 신뢰를 받고 있을 때는 이러한 모호함을 쉽게 극복할 수 있다.
청자가 듣는 것이 아니라 공감하고 있기 때문이다.

세 번째로그는 사례가 아니라 비유를 쓴다.15분의 영상에서 계속해서 '만약'을 가정한다.
...
자청은 환상을 만들어 판다.
수많은 소비자의 니즈를 자청은 정확히 가격하여 상품으로 만들어 판다.
내용은 중요하지 않다.
